          ...
          >
            <div className=" flex flex-col justify-center items-center p-8 gap-7">
              <h3 className=" text-2xl font-semibold to-slate-700">
                {type === "login" ? "Login Realance" : "Sign Up Realance"}
              </h3>
              <div className=" flex flex-col gap-5">
                ...
                />
                <button
                  className=" bg-[#427D9D] text-white px-12 text-lg font-semibold rounded-md p-3 w-80"
                  onClick={handleClick}
                >
                  Continue
                </button>
              ...
              <div className="flex flex-col gap-5">
                <button className=" text-white bg-blue-500 p-3 font-semibold w-80 flex items-center justify-center">
                  <MdFacebook className=" absolute left-12 text-2xl" />
                  Continue with Facebook
                </button>
                <button className=" border border-slate-300 p-3 font-medium w-80 flex items-center justify-center">
                  <FcGoogle className=" absolute left-12 text-2xl" />
            ...
            <div className=" py-5 w-full flex items-center justify-center border-t border-r-slate-400">
              <span className=" text-sm text-slate-700">
                ...
                {type === "login" ? (
                  <span
                    className=" text-[#427D9D] cursor-pointer"
                    onClick={() => {
                      dispatch({
