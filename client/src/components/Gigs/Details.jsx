  ...
  return (
    <>
      {gigData && currentImage !== "" && (
        <div className=" col-span-2 flex flex-col gap-3 mb-20">
          ...
          <div className=" flex items-center gap-2">
            <div>
              {gigData.createdBy?.profileImage ? (
                ...
                <div className=" bg-slate-800 h-10 w-10 flex items-center justify-center rounded-full relative">
            ...
            <div className=" flex items-center gap-1">
              ...
              <span className=" text-gray-500">({gigData.reviews.length})</span>
            </div>
          </div>
          <div className=" flex flex-col gap-4">
            <div className=" max-h-[800px] max-w-[1000px] overflow-hidden">
              <Image
          ...
          <div>
            <h3 className=" text-3xl my-5 font-medium text-gray-700">
              Deskripsi Jasa
            </h3>
            <div>
