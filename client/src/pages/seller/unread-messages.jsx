...
import { GET_UNREAD_MESSAGES, MARK_AS_READ_ROUTE } from "../../utils/constant";
    ...
    <div className=" min-h-[80vh] my-10 mt-0 px-32">
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table className=" w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <thead className=" text-xs text-gray-700 uppercase bg-gray-50 dark:bg-slate-200 dark:text-gray-700">
            <tr>
          ...
          <tbody>
            {messages.map((message) => {
              return (
                <tr
                  className=" bg-white dark:bg-gray-50 hover:bg-gray-100 dark: text-gray-700"
                  key={message.text}
                >
