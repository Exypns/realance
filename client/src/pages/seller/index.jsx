        ...
        <div className=" flex min-h-[80vh] my-10 mt-0 px-32 gap-5">
            ...
            <div className=" flex gap-5 justify-center items-center">
              <div>
                {userInfo?.imageName ? (
                  ...
                  <div className=" bg-slate-800 h-24 w-24 flex items-center justify-center rounded-full relative">
          ...
          <div>
            <div className=" grid grid-cols-3 gap-10 w-full">
              <div
                className=" shadow-md h-max p-10 flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all"
                onClick={() => router.push("/seller/gigs")}
              >
                <h2 className=" text-xl">Total Layanan Pekerjaan</h2>
              ...
              >
                <h2 className=" text-xl">Total Pesanan</h2>
                <h3 className=" text-blue-600 text-3xl font-extrabold">
              ...
              >
                <h2 className=" text-xl">Pesan yang belum dibaca</h2>
                <h3 className=" text-blue-600 text-3xl font-extrabold">
              ...
              <div className="shadow-md h-max p-10 flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all duration-300">
                <h2 className=" text-xl">Pendapatan Hari Ini</h2>
                <h3 className=" text-blue-600 text-3xl font-extrabold">
                  Rp.{dashboardData?.dailyRevenue}
                </h3>
              </div>
              <div className="shadow-md h-max p-10 flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all duration-300">
                <h2 className=" text-xl">Pendapatan Bulanan</h2>
                <h3 className=" text-blue-600 text-3xl font-extrabold">
                  Rp.{dashboardData?.monthlyRevenue}
                </h3>
              </div>
              <div className="shadow-md h-max p-10 flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all duration-300">
                <h2 className=" text-xl">Pendapatan Tahunan</h2>
                <h3 className=" text-blue-600 text-3xl font-extrabold">
                  Rp.{dashboardData?.revenue}
                </h3>
              </div>
            </div>
          </div>
